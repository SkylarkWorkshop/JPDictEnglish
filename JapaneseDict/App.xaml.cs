...
namespace JapaneseDict
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void CopyMainDb()
        {
            ...
            var jmfile = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///testdb.db"));
            if (await ApplicationData.Current.LocalFolder.TryGetItemAsync("maindb.db") == null)
            {
                await jmfile.CopyAsync(ApplicationData.Current.LocalFolder, "maindb.db");
            }
